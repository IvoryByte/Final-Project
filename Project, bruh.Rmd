...
title <- html_nodes(movies2018, "#top_movies_main .articleLink")
score <- html_nodes(movies2018, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2017, "#top_movies_main .articleLink")
score <- html_nodes(movies2017, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2016, "#top_movies_main .articleLink")
score <- html_nodes(movies2016, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2015, "#top_movies_main .articleLink")
score <- html_nodes(movies2015, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2014, "#top_movies_main .articleLink")
score <- html_nodes(movies2014, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2013, "#top_movies_main .articleLink")
score <- html_nodes(movies2013, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2012, "#top_movies_main .articleLink")
score <- html_nodes(movies2012, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2011, "#top_movies_main .articleLink")
score <- html_nodes(movies2011, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2010, "#top_movies_main .articleLink")
score <- html_nodes(movies2010, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2009, "#top_movies_main .articleLink")
score <- html_nodes(movies2009, "#top_movies_main .tMeterScore")
title <- html_nodes(movies2008, "#top_movies_main .articleLink")
score <- html_nodes(movies2008, "#top_movies_main .tMeterScore")
```