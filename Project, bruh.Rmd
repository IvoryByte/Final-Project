...
Next, we hve the distribution of critic scores, where we can see the majority of films lie between 80 and 100. The movies below 80 tend to be from before 2010, with the lowest score in 1998.  
...
Popular_movies%>%
  ...
  print(n = Inf)
```
The plots below compare a select group of movies' critic scores to their audience scores. 
...
![Hidden Figures](~/Mscs 264 S18/Inclass/Schrader_Voegele/__59dd139766efd.jpg)
![The Dark Knight](~/Mscs 264 S18/Inclass/Schrader_Voegele/13349231_f520.jpg)

```{r Tibble, echo= FALSE, message= FALSE}
