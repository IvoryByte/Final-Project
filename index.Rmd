...
These plots compare the number of reviewers to the score, showing their increase over time. The first plot shows the maximum number of reviewers, where the second shows the average number of reviewers. The thrid graph is scaled so that you can see both sets of data together, using the average reviewers. The red data shows scores, and the blue data shows the number of reviewers. 
